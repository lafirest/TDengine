...
https://github.com/taosdata/TDengine/docs/examples/python/connect_native_reference.py
...
https://github.com/taosdata/TDengine/docs/examples/python/connect_rest_examples.py:connect}}
...
示例代码位于 https://github.com/taosdata/TDengine/docs/examples/python
...
https://github.com/taosdata/TDengine/docs/examples/python/result_set_examples.py
```
##### TaosCursor 类的使用
...
https://github.com/taosdata/TDengine/docs/examples/python/cursor_usage_native_reference.py
```
...
1. TaosRestCursor 类的使用

`TaosRestCursor` 类是对 PEP249 Cursor 接口的实现。

```python title="TaosRestCursor 的使用"
https://github.com/taosdata/TDengine/docs/examples/python/connect_rest_examples.py:basic
```
...
https://github.com/taosdata/TDengine/docs/examples/python/rest_client_example.py
```
...
https://github.com/taosdata/TDengine/docs/examples/python/conn_native_pandas.py


2. REST  连接

https://github.com/taosdata/TDengine/docs/examples/python/conn_rest_pandas.py
...
https://github.com/taosdata/TDengine/docs/examples/python/handle_exception.py
