...
https://github.com/taosdata/TDengine/docs/examples/php/connect.php

#### 插入数据

https://github.com/taosdata/TDengine/docs/examples/php/insert.php

#### 同步查询

https://github.com/taosdata/TDengine/docs/examples/php/query.php

#### 参数绑定

https://github.com/taosdata/TDengine/docs/examples/php/insert_stmt.php
